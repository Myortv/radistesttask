...
```bash
git clone https://github.com/Myortv/...
cd ...
```
...
Мне лично несколько раз приходилось открывать код библиотеки, которая с питоном работает, чтобы понять, в каком формате данные уходят на сервер.
